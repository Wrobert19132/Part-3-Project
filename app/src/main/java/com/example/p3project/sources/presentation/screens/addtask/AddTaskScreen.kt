...
import com.example.p3project.sources.presentation.screens.addtask.components.ClickableTextField
                                ...
                                viewModel.onEvent(
                                    AddTaskEvent.AddTask(
                                        Task(
                                            taskName,
                                            taskDescription,
                                            targetTime = LocalTime.of(notificationTimePicker.hour, notificationTimePicker.minute),
